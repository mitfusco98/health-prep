...
def fresh_session_operation(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            db.session.close()
    return wrapper
from models import Patient, Appointment, Vital, Visit, Condition, Screening, PatientAlert
from app import db
