...
def create_comprehensive_medical_logs():
    ...
    with app.app_context():
        ...
        print(
            "  ✓ Documents (file-based): File names, upload dates/times, provider info"
        )
        print(
            "  ✓ Conditions (subject-based): Condition names, diagnosis dates/times, ICD codes"
        )
        print(
            "  ✓ Immunizations (subject-based): Vaccine names, administration dates/times, lot numbers"
        )
        print(
            "  ✓ Lab Results (test-based): Test names, result values, reference ranges"
        )
        print(
            "  ✓ Vital Signs (measurement-based): All vital parameters with dates/times"
        )
        print("  ✓ Imaging Studies (study-based): Study types, findings, impressions")
        print(
            "  ✓ Consultations (specialist-based): Specialist info, findings, recommendations"
        )
        print(
            "  ✓ Hospital Summaries (admission-based): Admission/discharge details, diagnoses"
        )
