...
def validate_screening_data(form_data: Dict[str, str]) -> Dict[str, List[str]]:
    ...
    if last_completed and not validate_date(last_completed):
        errors['last_completed'] = ['Invalid completion date format (YYYY-MM-DD expected)']
...
def validate_file_upload(filename: str, allowed_extensions: List[str] = None) -> Dict[str, List[str]]:
