...
class StructuredLogger:
    ...
    def _log_structured(
        ...
        **kwargs,
        ...
        json_message = json.dumps(
            log_entry, default=str, separators=(",", ":"), sort_keys=True
        )
    ...
    def performance_event(self, operation: str, duration_ms: float, **kwargs):
        ...
        self._log_structured(
            "info", f"Performance: {operation} took {duration_ms}ms", **kwargs
        )
    ...
    def audit_event(self, action: str, resource: str, result: str, **kwargs):
        ...
        self._log_structured(
            "info", f"Audit: {action} on {resource} - {result}", **kwargs
        )
