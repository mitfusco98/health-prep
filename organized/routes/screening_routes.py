...
def screening_list():
    ...
    if tab == 'types':
        ...
        screenings = Screening.query.join(Patient).order_by(
...
def add_screening_type():
    ...
    if request.method == 'POST':
        screening_type = ScreeningType(
            ...
            gender_specific=request.form.get('gender_specific') if request.form.get('gender_specific') else None,
...
def edit_screening_type(screening_type_id):
    ...
    if request.method == 'POST':
        ...
        screening_type.gender_specific = request.form.get('gender_specific') if request.form.get('gender_specific') else None
...
@screening_bp.route('/<int:patient_id>/<int:screening_id>/delete', methods=['GET', 'POST'])
