...
def add_appointment():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            flash(f'Appointment scheduled for {patient.full_name} on {appointment_date} at {appointment_time}', 'success')
...
def edit_appointment(appointment_id):
    ...
    if request.method == 'POST':
        ...
        if existing_appointment:
            flash('This time slot is already booked. Please choose a different time.', 'warning')
            return redirect(url_for('appointment.edit_appointment', appointment_id=appointment_id))
