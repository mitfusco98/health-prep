...
class ApplicationConfig:
    ...
    def _validate_configuration(self):
        ...
        insecure_defaults = [
            'dev_secret_key', 'your-secret-key-change-in-production',
            'change-me', 'default'
        ]
        ...
        if len(self.admin.password) < self.MIN_PASSWORD_LENGTH:
            issues.append(f"ADMIN_PASSWORD should be at least {self.MIN_PASSWORD_LENGTH} characters")
    ...
    def get_flask_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Cache settings
            'SEND_FILE_MAX_AGE_DEFAULT': 31536000 if self.environment == Environment.PRODUCTION else 0,
        }
