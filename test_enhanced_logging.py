...
def test_document_logging():
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(
            f"✓ Created document for patient {patient.first_name} {patient.last_name}"
        )
...
def test_condition_logging():
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(
            f"✓ Created condition for patient {patient.first_name} {patient.last_name}"
        )
...
def test_lab_result_logging():
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(
            f"✓ Created lab result for patient {patient.first_name} {patient.last_name}"
        )
...
def test_vital_signs_logging():
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(
            f"✓ Created vital signs for patient {patient.first_name} {patient.last_name}"
        )
...
def test_immunization_logging():
    ...
    with app.app_context():
        ...
        db.session.commit()
        print(
            f"✓ Created immunization for patient {patient.first_name} {patient.last_name}"
        )
...
def check_admin_logs():
    ...
    with app.app_context():
        ...
        recent_logs = (
            AdminLog.query.filter(AdminLog.request_id.like("test_%"))
            ...
            if log.event_details:
                try:
                    ...
                    if data_type == "alert":
                        ...
                        print(
                            f"   🏥 Condition: {details.get('condition_name', 'N/A')}"
                        )
                        print(
                            f"   📅 Diagnosis Date: {details.get('diagnosis_date', 'N/A')}"
                        )
                        ...
                        print(
                            f"   📅 Vaccination Date: {details.get('vaccination_date', 'N/A')}"
                        )
                        print(
                            f"   ⏰ Vaccination Time: {details.get('vaccination_time', 'N/A')}"
                        )
